...
export const IMAGES_FILTERS_FROM_STORAGE = "IMAGES_FILTERS_FROM_STORAGE";
export const UPDATE_IMAGES_FILTER = "UPDATE_IMAGES_FILTER";
export const CLEAR_IMAGES_FILTERS = "CLEAR_IMAGES_FILTERS";